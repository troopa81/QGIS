...
QgsSymbolLayer.ExtraItems.__doc__ = "String list of tuple (x,y,rotation angle) to define extra items to be rendered for templated line symbol layers. \n.. versionadded:: 4.0"
...
* ``ExtraItems``: String list of tuple (x,y,rotation angle) to define extra items to be rendered for templated line symbol layers.
