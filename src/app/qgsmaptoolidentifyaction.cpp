  ...
  : QgsMapToolIdentify( canvas )
{
  ...
  QgsMapLayerAction *attrTableAction = new QgsMapLayerAction( tr( "Show Attribute Table" ), mIdentifyMenu.get(), Qgis::LayerType::Vector, Qgis::MapLayerActionTarget::MultipleFeatures );
